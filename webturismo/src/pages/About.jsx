...
const About = () => {
  return (
    <div className="">
      ...
      <p>
        Este sitio reúne rutas temáticas por la ciudad y sus alrededores. Ya sea que te interese la
        historia romana, un paseo por la costa o una escapada a la montaña, aquí encontrarás el
        recorrido perfecto.
      </p>
      ...
      <h2>¿Quiénes somos?</h2>
      <p>
        Este proyecto nace con el objetivo de facilitar el turismo local, especialmente para quienes
        visitan Tarragona por primera vez o desean conocerla a fondo sin usar múltiples apps.
      </p>

      <h2>¿Cómo funciona?</h2>
      <p>
        Elige una ruta desde el menú o desde la página principal. Podrás ver los puntos destacados,
        un mapa en tiempo real y comentarios de otros visitantes.
      </p>
